...
if [ -z "$container" ]; then
  ...
  docker run -d --name=qbittorrent --restart=always -e PUID=$uid -e PGID=$gid -p 8080:8080 -p 23456:23456 -p 23456:23456/udp -v /data/videos/tools/qbittorrent:/config -v /data/videos/downloads:/data/downloads linuxserver/qbittorrent
else
